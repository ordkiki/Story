  ...
  return (
    <div>
        <div className="flex justify-between w-[65vw]">
                ...
                <div className=""><h1 className="font-bold text-2xl">{props.audio}</h1><h1>Read content</h1></div>
                <div className=""><h1 className="font-bold text-2xl">{props.published}</h1><h1>Read content</h1></div>
