...
//   return (
//     <div className='w-[100vw] h-[100vh] flex justify-center items-center'>
//       <form method='GET' action='/Browse?' onSubmit={EnvoyerRequete} className="p-4 max-w-sm mx-auto border">
//         <div className="mb-5">
//           <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900">
//             Votre adresse email
//           </label>
...
//           value="Connecter"
//         />
//         {/* <button className="text-black border hover:bg-black border-black hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"> 
//           connecter
//         </button> */}
...
export function Login() {
  ...
  const [message, setMessage] = useState(""); // Pour le retour visuel
